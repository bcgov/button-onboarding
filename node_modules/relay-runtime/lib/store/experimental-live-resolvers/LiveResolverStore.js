...
var LiveResolverStore = /*#__PURE__*/function () {
  function LiveResolverStore(source, options) {
    var _this = this;
    var _options$gcReleaseBuf, _options$gcScheduler, _options$getDataID, _options$log, _options$operationLoa, _options$treatMissing, _options$shouldProces;
    ...
    this._reactFlightPayloadDeserializer = options === null || options === void 0 ? void 0 : options.reactFlightPayloadDeserializer;
    this._reactFlightServerErrorHandler = options === null || options === void 0 ? void 0 : options.reactFlightServerErrorHandler;
  ...
  // real RelayModernStore can create. For now we just use any.
  ;
  _proto.subscribeToInvalidationState = function subscribeToInvalidationState(
  // $FlowFixMe
